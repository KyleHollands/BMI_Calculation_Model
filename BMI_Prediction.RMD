...
What metrics in the dataset are most associated with weight?
...
A much larger dataset should be used to build a better model. This would likely include the height predictor variable, 
which was not statistically significant in the previous model. A second model was created that included height, 
which is a common predictor for BMI models.
